...
[
	...
	FC_VENDOR=$(echo "$FC" | egrep -o 'gfortran|f77|g77|xlf|frt|pgf77|cf77|fort77|fl32|af77|xlf90|f90|pgf90|pghpf|epcf90|g95|xlf95|f95|fort|ifort|ifc|efc|pgfortran|pgf95|lf95|ftn|nagfor|mpifort' | { read first rest ; echo $first ; })
	...
	dnl Substitute the user-defined FCFLAGS into the autoconf output files.
	AC_SUBST(FC_VENDOR)
])
